		...
		<div id="panelInstructions">
			<div id="text">
				...
				<div id="hand">
					...
					<p> 
						Depending on the position of the hand, loudness of music, the colors and the opacity of the particles change. The rest of the interactions is triggered by clicks on some buttons.
					</p>
				</div>
				<div id="rangeCircle">
